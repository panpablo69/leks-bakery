const kategorieProduktow = [
    ...
    },
    {
        ...
        products: [
            ...
            { id: "chleb_2ab", name: "Chleb z pradawnej odmiany pszenicy 2ab", weight: "400g", packaging: "Karton 10 szt.", image: "img/chleb_2ab.png", shelfLife: "6 dni", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Lekkostrawny chleb z pradawnej pszenicy 2AB, pieczony na naturalnym zakwasie." },
            { id: "bulka_2ab", name: "Bułka z pradawnej odmiany pszenicy 2ab", weight: "70g", packaging: "Karton 60 szt. / Paleta: 40 kartonów", image: "img/bulka_2ab.png", shelfLife: "48h (Świeża)", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Lekkostrawna bułka z pradawnej pszenicy 2AB, przyjazna dla wrażliwych jelit." },
            { id: "bagietka_2ab", name: "Bagietka z pradawnej odmiany pszenicy 2ab", weight: "250g", packaging: "Karton 20 szt.", image: "img/bagietka_2ab.png", shelfLife: "48h (Świeża)", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Chrupiąca bagietka z pradawnej pszenicy 2AB o unikalnym aromacie." }
        ]
    },
    {
        id: "2ab",
        ...
        products: [
            { id: "chleb_2ab", name: "Chleb z pradawnej odmiany pszenicy 2ab", weight: "400g", packaging: "Karton 10 szt.", image: "img/chleb_2ab.png", shelfLife: "6 dni", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Lekkostrawny chleb z pradawnej pszenicy 2AB, pieczony na naturalnym zakwasie." },
            { id: "bulka_2ab", name: "Bułka z pradawnej odmiany pszenicy 2ab", weight: "70g", packaging: "Karton 60 szt. / Paleta: 40 kartonów", image: "img/bulka_2ab.png", shelfLife: "48h (Świeża) / 9 miesięcy (Bake-off)", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Lekkostrawna bułka z pradawnej pszenicy 2AB, przyjazna dla wrażliwych jelit." },
            { id: "bagietka_2ab", name: "Bagietka z pradawnej odmiany pszenicy 2ab", weight: "250g", packaging: "Karton 20 szt.", image: "img/bagietka_2ab.png", shelfLife: "48h (Świeża) / 9 miesięcy (Bake-off)", cert: "IFS Food, BRC, Certyfikat 2AB", isFresh: true, isFrozen: false, description: "Chrupiąca bagietka z pradawnej pszenicy 2AB o unikalnym aromacie." }
        ]
    },
    {
        id: "cukiernia",
