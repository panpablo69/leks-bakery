const kategorieProduktow = [
    ...
    },
    {
        ...
        products: [
            ...
            { id: "bulka_wysokobialkowa", name: "Bułka wysokobiałkowa", weight: "80g", packaging: "Karton 50 szt.", image: "img/bulka_wysokobialkowa.png", shelfLife: "48h / 9 miesięcy (Bake-off)", cert: "IFS Food, BRC", description: "Specjalna bułka o podwyższonej zawartości białka, polecana w diecie aktywnych." },
            ...
            { id: "bulka_z_marchewka", name: "Bułka z marchewką", weight: "80g", packaging: "Karton 50 szt.", image: "img/bulka_z_marchewka.png", shelfLife: "48h (Świeża)", cert: "IFS Food, BRC", description: "Aromatyczna bułka pszenna z dodatkiem utartej marchewki o delikatnie słodkawym smaku." },
            ...
            { id: "ciabatta_80g", name: "Ciabatta 80g.", weight: "80g", packaging: "Karton 50 szt. / Paleta: 40 kartonów", image: "img/ciabatta_80g.png", shelfLife: "48h (Świeża) / 9 miesięcy (Bake-off)", cert: "IFS Food, BRC", description: "Włoska bułka ciabatta z chrupiącą skórką i dużymi porami w puszystym miąższu." },
    ...
    },
    {
        ...
        products: [
            { id: "paluch_z_serem", name: "Paluch z serem", weight: "90g", packaging: "Karton 40 szt. / Paleta: 48 kartonów", image: "img/paluch_z_serem.png", shelfLife: "48h (Świeży)", cert: "IFS Food, BRC", description: "Chrupiący drożdżowy paluch pokryty zapieczonym żółtym serem." }
        ]
    }
];
